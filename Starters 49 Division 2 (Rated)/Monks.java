...
public class Main {
  ...
  // greedily try to make people with more money
  // monks and at the same time 
  // check if it is possible to assign everyone the 
  // same amount of money as current person 
  // if it is possible return ans 
  ...
  static void solve() throws Exception{
    ...
    for(int idx = n-1;idx>=1;idx--){
       long factor = (long)(idx+1)*arr[idx]-prefSum;
