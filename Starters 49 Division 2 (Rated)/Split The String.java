...
public class Main {
  ...
  // the idea is to pair up ones and zeros in one 
  // segment which results in badness value of zero
  // for that particular segment
  // and then equally distribute remaining
  // ones/zeros equally in all segments 
