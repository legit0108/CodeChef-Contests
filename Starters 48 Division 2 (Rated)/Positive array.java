...
public class Main {
  ...
  // accomodate current element in one of existing arrays
  // if possible , else start a new array
  ...
  static void solve() throws Exception{
    ...
    for(int idx=0;idx<n;idx++){
        ...
        if(val<minHeap.peek()){
            // occupy index 1 in new array
            // index 2 is free
            minHeap.add(2); 
        }else{
            // occupy index in existing array
            // index + 1 is free
            int minIdx = minHeap.remove();
            minHeap.add(minIdx+1);
        }
    }
