...
public class Main {
  ...
  // since we can make n/2 deletions
  // in the absolute worst case 
  // we will have n/2 zeros and n/2 ones
  // in this case we can delete all zeros or all ones to obtain palindrome
  // so find the number of ones and zeros in string
  // delete ones from string to make it all zeros if 
  // number of ones are less than zeros
  // and vice versa
