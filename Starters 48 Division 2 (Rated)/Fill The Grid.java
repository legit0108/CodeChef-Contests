...
public class Main {
  ...
  // if both n and m are odd we can
  // cover entire grid except one col and one row
  // if n is odd then we will not be able to cover one col
  // if m is odd then we will not be able to cover one row 
