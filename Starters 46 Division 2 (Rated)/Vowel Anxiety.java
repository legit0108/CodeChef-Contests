...
public class Main {
  ...
  // when count of vowel becomes odd you start appending at front
  // when it becomes even you start appending at end
  // finally the direction of output string depends on vowel count of str
  ...
  static void solve() throws Exception{
    ...
    if(vowelCount%2==0){
        while(deque.size()>0) sb.append(deque.removeFirst());
    }else{
        while(deque.size()>0) sb.append(deque.removeLast());
    }
