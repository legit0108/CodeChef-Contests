...
public class Main {
  ...
  static void solve() throws Exception{
    ...
    while(true){
        ...
        if((setBita==setBitb)&&(setBitb==setBitc)){
            break;
        }else{
            if(setBita==0l&&setBitb==0l){
                c++;
                if(a==0&&b==0){
                    sb.append("NO\n");
                    return;
                }
            }else if(setBita==0l&&setBitc==0l){
                b++;
                if(a==0&&c==0){
                    sb.append("NO\n");
                    return;
                }
            }else if(setBitb==0l&&setBitc==0l){
                a++;
                if(b==0&&c==0){
                    sb.append("NO\n");
                    return;
    ...
    if((a==b)&&(b==c))sb.append("YES\n");
    else sb.append("NO\n");
  }
  
  static long calc(long a,long n){
      long g = gcd(a,n-a);
      return g+(a*(n-a))/g;
  }
