...
public class Main {
  ...
  // Observation 1 : For a fixed number A , we can always
  // find B and C such that A ^ B ^ C = K
  
  // Observation 2 : A,B,C cannot be K , if one of them is K 
  // then other two numbers become equal
  ...
  static void solve() throws Exception{
      ...
      long ans = ((1l<<n)-1l)*((1l<<n)-2l); // (2^n-1)*(2^n-2)
