...
public class Main {
  ...
  /* 
    Reverse the process of merge.

    Do the exact opposite steps that are done when merging a and b to obtain c.
  ...
  */
  ...
  static void solve() throws Exception{
    ...
    while(ptr2<n) arr2.add(arr[ptr2++]);

    int size1 = arr1.size();
    int size2 = arr2.size();
    int size = size1+size2;

    if(size!=n) sb.append("-1\n");
    else{
      sb.append(size1).append("\n");
      for(long val : arr1) sb.append(val).append(" ");

      sb.append("\n");
      
      sb.append(size2).append("\n");
      for(long val : arr2) sb.append(val).append(" ");
      sb.append("\n");
    }
  }
