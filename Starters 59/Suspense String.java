...
public class Main {
  ...
  // Optimal play involves 0/1 to be placed at front/back depending on player's choice
  // For lexicographically small string, 0s should be placed in front and vice versa
  ...
  static void solve() throws Exception{
    ...
    while(start<=end){
        if(turn==0){
            ...
            if(ch=='0') deque.addFirst(0);
            else deque.addLast(1);
            start++;
        }else{
            char ch = str.charAt(end);
            if(ch=='1') deque.addFirst(1);
            else deque.addLast(0);
            end--;
        }
