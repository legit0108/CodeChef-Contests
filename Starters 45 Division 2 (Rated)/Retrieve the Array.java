...
public class Main {
  ...
  // example : lets take array a1 a2 a3 a4
  // what we are given : 
  // 1st index : 2a1 + a2 + a3 + a4
  // 2nd index : a1 + 2a2 + a3 + a4
  // 3rd index : a1 + a2 + 2a3 + a4
  // 4th index : a1 + a2 + a3 + 2a4
  
  // take sum of what is given
  // you get 5a1 + 5a2 + 5a3 + 5a4
  // divide by n+1 you get sum of array
  // finally obtain array element by subtracting
  // value at index and sum
  // value at index present twice so 
  // on subtraction it will leave behind original value 
  ...
  static void solve() throws Exception{
   ...
   for(int idx =0;idx<n;idx++) sum+=arr[idx];
   sum/=(long)(n+1);
   for(int idx =0;idx<n;idx++){
       sb.append(arr[idx]-sum).append(" ");
   }
